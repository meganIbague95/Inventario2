...
public class BotonEliminarInventario extends DefaultCellEditor{
	/**
	 * 
	 */
	...
	public BotonEliminarInventario(JCheckBox checkBox,ControladorInventario controladorInventario) {
		super(checkBox);
		...
		button.setActionCommand(ConstantesInterfaz.ELIMINAR_INVENTARIO);
	}
	...
	public Component getTableCellEditorComponent(JTable table, Object value,
		...
		controladorInventario.setIdInventarioEliminar(idInventario);
		return button;
	}
