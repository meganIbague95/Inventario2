...
public class ConstantesSQL {
	...
	public static final String CONSULTAR_OBJETO="SELECT nombre, ";
	...
	public static final String CONSULTAR_USUARIO_SEGURIDAD="SELECT contrasenia, conectado from Usuario where USUARIO=? AND estado='A'";
	...
	public static final String INSERTAR_PERFIL="INSERT INTO PERFIL(nombre,fechaCreacion,descripcion,usuario)values(?,sysdate(),?,?)";
	...
	public static final String EDITAR_USUARIO="UPDATE USUARIO SET contrasenia=?,idPerfil=?,estado=?,fechaModificacion=sysdate(), ultimoingreso=?, numeroingresos=?, intentosfallidos=?, conectado=? WHERE USUARIO=?";
