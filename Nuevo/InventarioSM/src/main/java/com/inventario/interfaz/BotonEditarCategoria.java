...
public class BotonEditarCategoria extends DefaultCellEditor{
	...
	public BotonEditarCategoria(JCheckBox checkBox,ControladorInventario controladorInventario) {
		super(checkBox);
		this.controladorInventario=controladorInventario;
		button = new JButton("Editar");
		button.setOpaque(true);
		button.addActionListener(controladorInventario);
		button.setActionCommand(ConstantesInterfaz.ABRIR_EDITAR_CATEGORIA);
	...
	public Component getTableCellEditorComponent(JTable table, Object value,
		...
		isPushed = true;
		Integer idCategoria= new Integer(table.getValueAt(row, 0).toString());
		controladorInventario.setIdCategoriaEditar(idCategoria);
		return button;
	}
