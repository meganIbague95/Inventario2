...
public class BotonEliminarTamanio extends DefaultCellEditor{
	...
	public BotonEliminarTamanio(JCheckBox checkBox,ControladorInventario controladorInventario) {
		super(checkBox);
		this.controladorInventario=controladorInventario;
		button = new JButton("Eliminar");
		button.setOpaque(true);
		button.addActionListener(controladorInventario);
		button.setActionCommand(ConstantesInterfaz.ELIMINAR_TAMANIO);
	...
	public Component getTableCellEditorComponent(JTable table, Object value,
		...
		isPushed = true;
		Integer idTamanio= new Integer(table.getValueAt(row, 0).toString());
		controladorInventario.setIdTamanioEliminar(idTamanio);
		return button;
	}
